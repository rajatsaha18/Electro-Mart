...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/11-06-2021/electronics-mart-liberty-demo_Free/1081434887/web/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Dec 2022 05:04:42 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!-- Custom-Files -->
    <link href="{{ asset('/') }}website/assets/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
    <!-- Bootstrap css -->
    ...
    <link href="{{ asset('/') }}website/assets/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
    <!-- pop-up-box -->
    <link href="{{ asset('/') }}website/assets/css/menu.css" rel="stylesheet" type="text/css" media="all" />
    <!-- menu style -->
    <!-- //Custom-Files -->

    <!-- web fonts -->
    <link
        href="http://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&amp;display=swap"
        rel="stylesheet">
    <!-- //web fonts -->
</head>
...
============================================================ */
            ...
            <div class="container">
                <div class="row header-bot_inner_wthreeinfo_header_mid align-items-center">
                    ...
                    <div class="col-lg-3 col-md-4 logo_agile">
                        <h1>
                            <a href="{{ route('home') }}"><span>E</span>lectronics <span>M</span>art</a>
                        </h1>
                    </div>
                    <!-- //logo -->
                    <!-- header-bot -->
                    <div class="col-lg-9 col-md-8 header">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-sm-8 agileits_search">
                                ...
                                <form class="form-inline" action="{{ route('product-search',['id' =>$product->id]) }}" method="post" style="max-width:600px;">
                                    @csrf
                                    <input class="form-control" type="search" id="name" name="name"
                                        placeholder="Search for products, brands and more" aria-label="Search"
                                        required>
                                    <button class="btn" id="btn-search" name="submit" type="submit"><i class="fa fa-search"
                            ...
                            <div
                                ...
                                <div class="wthreecartaits wthreecartaits2 cart cart box_1">
                                    <a href="{{ route('show-cart') }}">
                                        <img src="{{ asset('/') }}website/assets/image/cart.png" alt=""
                                            height="40" width="40" class="img-fluid">
                                    </a>
                                    {{-- <form action="" method="post" class="last text-right">
                                        ...
                                        <button class="btn w3view-cart p-0" type="submit" name="submit"
                                            value="">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="agileits-navi_search">
						...
						<select id="agileinfo-nav_search" name="agileinfo_search" required="">
							...
							<a href="{{ route('product-about') }}">Televisions</a>
							<a href="">Headphones</a>
							<a href="">Computers</a>
							<a href="">Appliances</a>
							<a href="">Mobiles</a>
                                            ...
                                            <div class="col-sm-6 multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    @foreach ($categories as $category)
                                                        <li>
                                                            <a
                                                                href="{{ route('product-about', ['id' => $category->id]) }}">{{ $category->name }}</a>
                            ...
                            <div class="join-agile text-left p-4">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 offerimg-w3l">
                                        <img src="{{ asset('/') }}website/assets/images/off1.png" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        ...
                        <a href="product.html">
                            <div class="join-agile text-left p-4">
                                <div class="row ">
                                    ...
                                    <div class="col-sm-5 offerimg-w3l">
                                        <img src="{{ asset('/') }}website/assets/images/off2.png" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="agile-sometext py-5">
                <div class="container">
                    ...
                    <div class="sub-some child-momu mt-4">
                        ...
                        <ul>
                            <li>
                                <img src="{{ asset('/') }}website/assets/images/pay2.png" alt="">
                            </li>
                            <li>
                                <img src="{{ asset('/') }}website/assets/images/pay5.png" alt="">
                            </li>
                            <li>
                                <img src="{{ asset('/') }}website/assets/images/pay1.png" alt="">
                            </li>
                            <li>
                                <img src="{{ asset('/') }}website/assets/images/pay4.png" alt="">
                            </li>
                            <li>
                                <img src="{{ asset('/') }}website/assets/images/pay6.png" alt="">
                            </li>
                            <li>
                                <img src="{{ asset('/') }}website/assets/images/pay3.png" alt="">
                            </li>
                            <li>
                                <img src="{{ asset('/') }}website/assets/images/pay7.png" alt="">
                            </li>
                            <li>
                                <img src="{{ asset('/') }}website/assets/images/pay8.png" alt="">
                            </li>
                            <li>
                                <img src="{{ asset('/') }}website/assets/images/pay9.png" alt="">
                            </li>
                        </ul>
                    </div>
                    <!-- //payment -->
    ...
    <!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/11-06-2021/electronics-mart-liberty-demo_Free/1081434887/web/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Dec 2022 05:05:07 GMT -->
